...
const obtenerResultadosExito = (limit) => {
  const resultados = [
    ...
    {
      nombreProducto: 'Televisor LED Samsung 160 Cms 65 Pulgadas UHD Smart UN65TU7000',
      precioProducto: 2299900,
      descripcionProducto: 'Colores y detalles diseñados para ti. Pantalla Crystal Display: Sumérgete en tus contenidos con una gama de colores mucho más amplia. La pantalla Crystal Display garantiza una expresión de colores optimizada para que no te pierdas ningún detalle.',
      localizacion: 'N/A',
      fotoProducto: 'https://exitocol.vtexassets.com/arquivos/ids/4730748-800-auto?width=800&height=auto&aspect=true',
      esUsado: false,
      tienda: 'Exito',
      enlaceProducto: 'https://www.exito.com/televisor-samsung-crystal-65-pulgadas-uhd-4k-smart-tv-2020-tu7000-586614/p',
    },
    {
